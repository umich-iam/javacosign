...
public class CosignServer
{
  ...
  /**
   * 
   * @uml.property name="config" @uml.associationEnd multiplicity="(1 1)"
   */
  ...
  public CosignServer(String address, String port, String configString)
  {
    ...
    System.out.println( "Registering cosign server = " + address + ":" + port + ":" + configString );//TODO
  }

  private GenericObjectPool.Config parseConfigString( String configString )
  {
    if ( null == configString || configString.trim().equals( "" ) )
    {
